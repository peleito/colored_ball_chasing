...
echo_and_run cd "/home/team1/autonomy_ws/src/experimental_robotics_course/src/simple_drive"
...
echo_and_run /usr/bin/env \
    ...
    "/home/team1/autonomy_ws/src/experimental_robotics_course/src/simple_drive/setup.py" \
     \
    build --build-base "/home/team1/autonomy_ws/build/experimental_robotics_course/src/simple_drive" \
    install \
    --root="${DESTDIR-/}" \
