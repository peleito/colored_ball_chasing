...
#include "../../../../src/binary_detector/include/binary_detector/groupbox.h"
...
void binary_detector::GroupBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupBox::minLCDSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (GroupBox::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupBox::maxLCDSignal)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject binary_detector::GroupBox::staticMetaObject = {
    { &QGroupBox::staticMetaObject, qt_meta_stringdata_binary_detector__GroupBox.data,
      qt_meta_data_binary_detector__GroupBox,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
