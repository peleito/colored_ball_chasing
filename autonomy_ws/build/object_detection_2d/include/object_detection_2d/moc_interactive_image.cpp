...
#include "../../../../src/object_detection_2d/include/object_detection_2d/interactive_image.h"
...
void object_detection_2d::InteractiveImage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InteractiveImage::mousePressSignal)) {
                *result = 0;
            }
        }
        {
            typedef void (InteractiveImage::*_t)(const QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InteractiveImage::mouseMoveSignal)) {
                *result = 1;
            }
        }
        {
            typedef void (InteractiveImage::*_t)(const QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InteractiveImage::mouseReleaseSignal)) {
                *result = 2;
            }
        }
        {
            typedef void (InteractiveImage::*_t)(const QRect & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&InteractiveImage::areaSelected)) {
                *result = 3;
            }
        }
    }
...
const QMetaObject object_detection_2d::InteractiveImage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_object_detection_2d__InteractiveImage.data,
      qt_meta_data_object_detection_2d__InteractiveImage,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *object_detection_2d::InteractiveImage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_object_detection_2d__InteractiveImage.stringdata0))
        return static_cast<void*>(const_cast< InteractiveImage*>(this));
