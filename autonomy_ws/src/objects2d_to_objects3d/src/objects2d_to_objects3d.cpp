...
private:
  ...
  static constexpr int half_image_width {1920/2};
  static constexpr int half_image_height {1080/2};
  static constexpr double fov_x_deg {64};
  static constexpr double fov_y_deg {41};
